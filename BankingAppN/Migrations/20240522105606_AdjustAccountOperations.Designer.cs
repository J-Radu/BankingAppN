...
namespace BankingAppN.Migrations
{
    ...
    [Migration("20240522105606_AdjustAccountOperations")]
    partial class AdjustAccountOperations
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BankingApp.Models.AccountOperation", b =>
                {
                    ...
                    b.Property<string>("AccountNumberDestination")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("BankingAppN.Data.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
